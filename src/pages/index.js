        ...
        <>
            ...
            <div className="w-screen overflow-hidden">
                ...
                <div className="h-[55vh] flex z-[10]">
                    ...
                    <div className="w-[55%] bg-oblack hidden lg:block">
                ...
                <div className="w-full flex flex-col justify-start items-start lg:items-end p-8 lg:p-4 lg:pr-[3rem] relative z-10 text-white">
